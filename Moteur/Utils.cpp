    ...
    Microsoft::WRL::ComPtr<ID3D12Resource>& uploadBuffer)
{
    ...
    CD3DX12_RESOURCE_BARRIER iValue5 = CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer.Get(),
        D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_COPY_DEST);
    cmdList->ResourceBarrier(1, &iValue5);

    UpdateSubresources<1>(cmdList, defaultBuffer.Get(), uploadBuffer.Get(), 0, 0, 1, &subResourceData);

    CD3DX12_RESOURCE_BARRIER iValue6 = CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer.Get(),
